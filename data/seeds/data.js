...
exports.seed = async function (knex) {
  ...
  await knex("tarifler").insert(ornekTarif);
  ...
  await knex("adimlar").insert(ornekAdimlar);

  const ornekIcindekiler = [
    {
  ...
  await knex("icindekiler").insert(ornekIcindekiler);

  const ornekIcindekilerAdimlar = [
    { icindekiler_id: 1, adim_id: 1, miktar: 0.1 },
    { icindekiler_id: 2, adim_id: 1, miktar: 1 },
    { icindekiler_id: 2, adim_id: 2, miktar: 0.5 },
  ];
  await knex("icindekiler_adimlar").insert(ornekIcindekilerAdimlar);
};
